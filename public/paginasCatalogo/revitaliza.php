<?php if (in_array('ENERGÍA Y REVITALIZACIÓN', $lineas_pais)) { ?>
	<!-- ========================= Section 1 revitaliza======================= -->
	<div class="section" id="revitaliza" data-anchor="revitaliza">

		<!-- ========================= revitaliza Slide 1 [Portada principal]======================= -->
		<div class="slide" id="revitaliza_slide1">
			<!-- contenido-->
		...
		foreach ($productos as $key => $value) {
			if ($value->linea == 'ENERGÍA Y REVITALIZACIÓN' && $value->is_destacado == 1) {
				array_push($destacado, $value);
			} //end if
		} //end foreach
		?>
		<div class="slide" id="revitaliza_slide2">
	 ...
	 ******************* -->
		...
		foreach ($productos as $key => $value) {
			...
			if ($value->linea == 'ENERGÍA Y REVITALIZACIÓN' && strlen($value->orden_str) <= 3) {
				/******************************************
	...
	</div><!-- end section revitaliza --->
<?php } //end if in array
else {
	echo '<script>$("#lirevitaliza").hide();</script>';
} ?>