<?php if (in_array('VIGOR MENTAL', $lineas_pais)) { ?>
	<!-- ========================= Section 1 vigormental======================= -->
	<div class="section" id="vigormental" data-anchor="vigormental">

		<!-- ========================= vigormental Slide 1 [Portada principal]======================= -->
		<div class="slide" id="vigormental_slide1">
			<!-- contenido-->
		...
		foreach ($productos as $key => $value) {
			if ($value->linea == 'VIGOR MENTAL' && $value->is_destacado == 1) {
				array_push($destacado, $value);
			} //end if
		} //end foreach
		?>
		<div class="slide" id="vigormental_slide2">
	 ...
	 ******************* -->
		...
		foreach ($productos as $key => $value) {
			...
			if ($value->linea == 'VIGOR MENTAL' && strlen($value->orden_str) <= 3) {
				/******************************************
		...
		?>
	</div><!-- end section vigormental --->
<?php } //end if in array
else {
	echo '<script>$("#livigormental").hide();</script>';
} ?>