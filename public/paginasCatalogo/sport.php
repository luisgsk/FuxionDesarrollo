<?php if (in_array('NUTRICIÓN Y REGENERACIÓN', $lineas_pais)) { ?>
	<!-- ========================= Section 1 sport======================= -->
	<div class="section" id="sport" data-anchor="sport">

		<!-- ========================= sport Slide 1 [Portada principal]======================= -->
		<div class="slide" id="sport_slide1">
			<!-- contenido-->
		...
		foreach ($productos as $key => $value) {
			if ($value->linea == 'SPORT' && $value->is_destacado == 1) {
				array_push($destacado, $value);
			} //end if
		} //end foreach
		?>
		<div class="slide" id="sport_slide2">
	 ...
	 ******************* -->
		...
		foreach ($productos as $key => $value) {
			...
			if ($value->linea == 'SPORT' && strlen($value->orden_str) <= 3) {
				/******************************************
	...
	</div><!-- end section sport --->
<?php } //end if in array
else {
	echo '<script>$("#lisport").hide();</script>';
} ?>