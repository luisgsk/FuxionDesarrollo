<?php if (in_array('CONTROL DE PESO Y MEDIDAS', $lineas_pais)) { ?>
	...
	<div class="section" id="controlpeso" data-anchor="controlpeso">
		...
		<?php
		/********************************************************
		Extraigo del array el producto destacado
		para la portada.
		 ********************************************************/

		$destacado = array();
		foreach ($productos as $key => $value) {
			if ($value->linea == 'CONTROL DE PESO Y MEDIDAS' && $value->is_destacado == 1) {
	 ...
	 ******************* -->
		...
		foreach ($productos as $key => $value) {
			...
			if ($value->linea == 'CONTROL DE PESO Y MEDIDAS' && strlen($value->orden_str) <= 3) {
				/******************************************
		...
		?>
	</div><!-- end section controlpeso --->
<?php } //end if in array
else {
	echo '<script>$("#licontrolpeso").hide();</script>';
} ?>