...
Route::get('/{orden}/{token}/{nombre}/{pais}', 'CatalogoController@index')->where(['orden' => '[0-8]', 'token' => '[0-9]+' ,'pais' => 'pe|ec|PE|EC|co|CO|us|US|pa|PA|es|ES|ar|AR|bo|BO|cl|CL|gt|GT|mx|MX|cr|CR']);
